...
#### Désormais disponible sur Windows, Mac, Android et bientôt Linux (la version Windows marche sans problèmes sur Linux à l'aide de wine), ce logiciel reprenant l'esthétique des personnages de la chaîne YouTube de Trash vous propose de créer un personnage (appelé chibi) à votre image à l'aide d'éléments personnalisés dont certains sont dessinés par nos soins.
